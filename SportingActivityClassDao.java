...
public interface SportingActivityClassDao {
    ...
    /*    @Query("SELECT * FROM SportingActivityClass WHERE customerId like:customerId||'%' AND activityTitle = :title")
    LiveData<List<SportingActivityClass>> getSportingActivityByCustomerAndTitle(int customerId, String title);
*/
