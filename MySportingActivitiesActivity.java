...
public class MySportingActivitiesActivity extends AppCompatActivity {
    ...
    LiveData<List<SportingActivityClass>> sportingActivityLiveData;
...
/*
        customer_name.setText("הפעולות של " + currentCustomer.getName() + currentCustomer.getId());
*/search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                String sportTitle = s.toString().toLowerCase();
...
*/
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                allSportingActivities = new ArrayList<>(sportingActivities);
            }
        }).start();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        customerSportingActivitiesList = currentCustomer.getSportingActivityClasses();
